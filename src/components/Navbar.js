            ...
            <Navbar className='navbar' expand="lg">
                <Container fluid>
                    ...
                    >
                        ...
                        <NavDropdown title={<img src="https://www.freeiconspng.com/thumbs/profile-icon-png/account-profile-user-icon--icon-search-engine-10.png" className="p-icon" />} id="navbarScrollingDropdown">
